    ...
    <footer className="footerContainer">
      <div className="footerInner">
        <div className="footerName">
          <div className="footerNameText">
            Berathan Yedibela | Tech Entrepreneur
          </div>
        </div>
        <div className="footerSocial">
          <div className="footerSocialInner">
            <a
              href="https://www.instagram.com/theberathan"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              href="https://github.com/Ber4tBey"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.linkedin.com/in/berathan-yedibela-060b73244/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
        ...
        <div className="footerCopyright">
          <div className="footerCopyrightText">
            2024 &#169; theberathan | Tüm hakları saklıdır.
          </div>
        </div>
      </div>
    </footer>
